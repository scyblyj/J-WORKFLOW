<template>
  <div>
    <div v-for="(item, idx) in nodeCfg" :key="idx" class="data_div">
      <div v-if="item.type !== 9" class="node">
        <div
          class="title"
          :style="{
        ...
        >
          <div v-if="item.type !== 0" class="not_root"></div>
          <div class="title_name">{{ item.name }}</div>
          <div>
            <i class="title_icon" :class="titleIconForType(item.type)"></i>
          </div>
        </div>
        ...
        <div class="content">
          ...
          <div v-if="item.type !== 0" class="extra">
            ...
            <div class="op">
              ...
              >
                <i
                  class="el-icon-caret-top op_icon"
                  @click="onMoveUpNode(idx)"
                ></i>
              </el-tooltip>
              <el-tooltip
                v-if="idx < nodeCfg.length - 1"
                effect="dark"
                content="向后移动"
                :open-delay="300"
                placement="bottom"
              >
                <i
                  class="el-icon-caret-bottom op_icon"
                  @click="onMoveDownNode(idx)"
                ></i>
              </el-tooltip>
              <el-tooltip
                effect="dark"
              ...
              >
                <i
                  class="el-icon-copy-document op_icon"
                  @click="onDupNode(idx, item)"
                ></i>
              </el-tooltip>
              <el-tooltip
                effect="dark"
                ...
                placement="bottom"
              >
                <i class="el-icon-delete op_icon" @click="onDelNode(idx)"></i>
              </el-tooltip>
            </div>
          </div>
        </div>
      ...
      <div class="condition" v-if="item.type == 9">
        <div class="condition_add_btn">添加条件</div>
